...
test('filter Grocery Group based on item name with 1 object in list', () => {
...
test('filter Grocery Group based on brand with multiple object in list', () => {
...
test('filter Group with invalid input', () => {
    expect(() => filterGroceryGroupBy(group, '', '')).toThrowError('Invalid input');
});

test('filter Grocery Group based on store name with 1 object in list', () => {
...
test('filter Grocery Group based on price name with 1 object in list', () => {
