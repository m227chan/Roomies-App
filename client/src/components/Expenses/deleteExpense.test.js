...
test('delete the first element of the expense table', () => {
...
test('delete a middle element in the expenses', () => {
...
test('delete expense with invalid input', () => {
    expect(() => deleteExpenses(expenses, -1)).toThrowError('Invalid input');
});

test('delete expense with not found input', () => {
