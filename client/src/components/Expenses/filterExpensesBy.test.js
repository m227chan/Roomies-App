...
test('filter expenses table based on tag with 1 object in list', () => {
...
test('filter expenses table based on tag with multiple object in list', () => {
...
test('filter expenses with invalid input', () => {
    expect(() => filterExpensesBy(expenses, 'tag', '')).toThrowError('Invalid input');
});

test('filter expenses table based on amount with 1 object in list', () => {
...
test('filter expenses table based on amount with multiple object in list', () => {
...
test('filter expenses table based on idSpender', () => {
...
test('filter expenses table based on idDebtor', () => {
